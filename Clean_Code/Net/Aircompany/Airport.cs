...
namespace Aircompany
{
    public class Airport
    {
        ...
        {
            foreach (MilitaryPlane militaryPlane in GetTransportMilitaryPlanes().ToList())
                return militaryPlane.GetPlaneTypeIs() == MilitaryType.TRANSPORT;
            return false;
        }

        public bool GetSortPlaneByMaxLoadCapacity()
        {
            List<Plane> planesSortedByMaxLoadCapacity = SortByMaxLoadCapacityFlights().GetPlanes().ToList();
